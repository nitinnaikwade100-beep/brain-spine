export const blogs = [
  ...
  {
    id: 6,
    title: "Advanced Stroke Care: When Every Second Matters",
    meta: "Discover how advanced AI-based stroke modules and rapid interventions like IV Thrombolysis are ensuring faster decisions and better recovery outcomes.",
    image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=800&q=80",
    content: (
      <div className="space-y-4 text-slate-700 leading-relaxed">
        <h3 className="text-xl font-bold text-slate-900 font-serif">Introduction</h3>
        <p>A stroke is a medical emergency where every single minute counts. When blood flow to a part of the brain is interrupted, brain cells begin to die rapidly. However, with the advent of advanced stroke care protocols and cutting-edge technology, we are now able to intervene faster and more effectively than ever before, dramatically improving recovery outcomes.</p>
        
        <h3 className="text-xl font-bold text-slate-900 font-serif mt-6">Comprehensive Care for Brain & Stroke Disorders</h3>
        <p>Modern stroke management relies on a comprehensive approach that begins the moment a patient arrives at the emergency room. Utilizing advanced AI-based stroke modules, we can now analyze brain scans in seconds. This technology helps in rapidly identifying the exact location of the blockage or hemorrhage, ensuring that treatment decisions are made swiftly and accurately.</p>

        <h3 className="text-xl font-bold text-slate-900 font-serif mt-6">Immediate Stroke Treatment Options</h3>
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>IV Thrombolysis:</strong> For ischemic strokes, administering clot-busting medications (tissue plasminogen activator, or tPA) within the first few hours can dissolve the clot and restore blood flow.</li>
          <li><strong>Mechanical Thrombectomy:</strong> In cases of large vessel occlusions, specialized endovascular techniques are used to physically remove the clot from the brain, often providing immediate relief of symptoms.</li>
          <li><strong>Acute Ischemic Stroke Treatment:</strong> Tailored protocols ensure that patients receive the most appropriate intervention based on their specific type of stroke and the time elapsed since symptoms began.</li>
        </ul>

        <h3 className="text-xl font-bold text-slate-900 font-serif mt-6">The Importance of Expert Neurological Care</h3>
        <p>Having a dedicated team of neuro-interventionists and stroke specialists available 24/7 is crucial. The combination of rapid diagnostic tools and immediate access to advanced treatments like intracranial stenting and mechanical thrombectomy means that patients have the best possible chance of a full recovery.</p>

        <h3 className="text-xl font-bold text-slate-900 font-serif mt-6">Conclusion</h3>
        <p>Stroke care has evolved significantly, shifting from a focus on rehabilitation to proactive, immediate intervention. By leveraging AI technology and advanced endovascular techniques, we are saving lives and preserving brain function.</p>

        <div className="bg-sky-50 p-6 rounded-xl mt-8 border border-sky-100">
          <h4 className="font-bold text-sky-900 mb-2">Take Action</h4>
          <p className="text-sky-800 text-sm">Remember the signs of a stroke (B.E. F.A.S.T. - Balance, Eyes, Face, Arms, Speech, Time) and seek immediate medical attention. For expert stroke care and neuro-emergencies, contact our 24/7 emergency line at <strong>+91 9823012307</strong>.</p>
        </div>
      </div>
    )
  }
